...
""" I noticed that the only one that needs to be "numbers" with an s in the above"""
"""2 lines is the one after "in". Yet if they are all "numbers" is still works."""
"""why is this? i dont quite understand it?"""
print(large_numbers)